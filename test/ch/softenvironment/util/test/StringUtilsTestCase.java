...
public class StringUtilsTestCase extends junit.framework.TestCase {
    ...
    public void testEncoding() {
		...
		assertFalse("Character NOT same in ANSI & UTF-8", "ä".equals(valISO));
		assertTrue("Character reversed to UTF-8", "ä".equals(new String("ä".getBytes(), Charset.forName("UTF-8"))));
	}
}
