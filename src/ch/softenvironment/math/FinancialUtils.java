...
public class FinancialUtils {
	 ...
	 * Interest-Amount = (Capital * InterestRate * Time) / 100 [where: Time=1
	 * Year]
	 * 
	 * @param capital
	...
	/**
	 * Als Abschreibung wird der betriebswirtschaftlich zu ermittelnde
	 * Wertverlust des Produktionsvermoegens (Anlagevermoegen und
	 * Umlaufvermoegen) bezeichnet. Hierbei ist es unerheblich, aus welchem
	 * Grund (Abnutzung, Alterung oder Unfallschaden) dieser Wertverlust
	 * herbeigefuehrt wird.
	 * 
	 * <b>Lineare Abschreibung:</b> Die Anschaffungskosten des abzuschreibenden
	 * Wirtschaftsgutes (WG) werden gleichmaessig auf die Jahre der
	 * Nutzungsdauer aufgeteilt. Damit wird jedes Jahr der gleiche Betrag
	 * abgeschrieben. Am Ende der Nutzungsdauer ist das WG vollstaendig
	 * abgeschrieben, es sei denn, das WG wird nur bis auf den Schrottwert
	 * abgeschrieben. Dann wird der Differenzbetrag aus Anschaffungskosten und
	 * Schrottwert abgeschrieben. Der Abschreibungswert wird mit der folgenden
	 * Formel berechnet: Konstanter Abschreibungswert = Anschaffungswert /
	 * Nutzungsdauer
	 * 
	 * @param duration
	 *            (de: Nutzungdauer)
	 * @param timeOfInterest
	 *            (same UNIT as duration, for e.g. month or year)
	 * @param capital
	 ...
	 * bestimmter Prozentsatz von Anschaffungskosten des Wirtschaftsgutes (WG)
	 * festgelegt und abgeschrieben. In den darauffolgenden Jahren wird dieser
	 * festgelegte Prozentsatz von dem noch uebrigen Wert des WG (Restbuchwert)
	 * abgeschrieben. Der Abschreibungsbetrag wird bei dieser Methode folglich
	 * immer kleiner. Das WG ist am Ende der geplanten Nutzungsdauer nicht
	 * vollstaendig abgeschrieben.
	 * 
	 * Formula (see
	 ...
	 *            (de: %-Satz der jaehrlich vom Buchwert abgeschrieben werden
	 *            soll)
