...
public class FinancialUtils {
    ...
    /**
     * Als Abschreibung wird der betriebswirtschaftlich zu ermittelnde Wertverlust des Produktionsvermögens 
     * (Anlagevermögen und Umlaufvermögen) bezeichnet. Hierbei ist es unerheblich, aus welchem Grund 
     ...
     * In den darauffolgenden Jahren wird dieser festgelegte Prozentsatz von dem noch übrigen Wert des WG (Restbuchwert) 
     * abgeschrieben. Der Abschreibungsbetrag wird bei dieser Methode folglich immer kleiner. Das WG ist am Ende der 
     * geplanten Nutzungsdauer nicht vollständig abgeschrieben.
     * 
     ...
     * @param interestRatePercent (de: %-Satz der jährlich vom Buchwert abgeschrieben werden soll)
    ...
    /*  
        //Jährlicher Abschreibungsbetrag r[year] = capital[year] * (1-i)^(year-1) * i;
    */
