...
/**
 * This is a simple C-Array Vector used for vectorial (mathematical sense)
 * operations. Ths vector is not ment to be resized after initialization.
 *
...
/**
 * Length of a Vector (german: Betrag)
 * |vec| = sqrt(vec*vec)
 */
