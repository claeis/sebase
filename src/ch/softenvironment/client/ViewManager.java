...
public class ViewManager {
     ...
     * 
     * @param objects
     *            model-instances to be represented (null for SearchView's)
     * @param view
     *            DetailView AND/OR SearchView
     */
    ...
    /**
     * Unregister the closing View, to be no more representable for registered
     * objects any more.
     * 
     * @param view
     *            DetailView AND/OR SearchView
    ...
    /**
     * Return specified rights for a given model class (represented by different
     * views) in the following hierarchy: 1) if specific rights are set for
     * class return those rights 2) if default rights are set for ALL
     * model-classes return those default rights 3) otherwise all rights are
     * allowed
     * 
     * @param model
     *            (Model class to be checked for manipulating rights)
     * @return
     * @see #setRights()
    ...
    /**
     * Register rights for a specific model-class, which overwrites default
     * rights for given model-class.
     * 
     * @param model
     * @param rights
     */
