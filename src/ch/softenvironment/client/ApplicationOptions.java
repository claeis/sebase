...
public class ApplicationOptions extends java.util.Properties implements UserSettings {
	...
	/**
	 * Sets the 'Look & Feel' property (java.lang.String) value. This Font is
	 * used for graphical nodes and edges.
	 * 
	 * @param font
	 *            The new value for the property.
	 * @see #getLookAndFeel
	...
	/**
	 * Cache OS locale before a reset of default Locale might happen by these
	 * settings.
	 * 
	...
	/**
	 * In multi-language applications the change of the default locale because
	 * of the language only might also influence other platform settings badly
	 * (such as NumberFormat for e.g.).
	 * 
