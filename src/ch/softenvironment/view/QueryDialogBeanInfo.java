...
/**
 * The bean information class for ch.softenvironment.view.QueryDialog.
 * @author Peter Hirzel <i>soft</i>Environment
 * @version $Revision: 1.2 $ $Date: 2004-02-05 11:33:00 $
 */
public class QueryDialogBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return ch.softenvironment.view.QueryDialog.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "ch.softenvironment.view.QueryDialog";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the QueryDialogBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(ch.softenvironment.view.QueryDialog.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the isOk() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor isOkMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the isOk() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("isOk", aParameterTypes);
		} catch (java.lang.Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "isOk", 0);
		};
		try {
		...
		/* aDescriptor.setDisplayName("isOk()"); */
		/* aDescriptor.setShortDescription("isOk()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
	} catch (java.lang.Throwable exception) {
