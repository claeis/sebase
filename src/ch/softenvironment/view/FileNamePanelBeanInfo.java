...
/**
 * The bean information class for ch.softenvironment.view.FileNamePanel.
 * @author Peter Hirzel <i>soft</i>Environment
 * @version $Revision: 1.2 $ $Date: 2004-02-05 11:32:59 $
 */
public class FileNamePanelBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the fileNamePanel event set descriptor.
 * @return java.beans.EventSetDescriptor
 */
public java.beans.EventSetDescriptor fileNamePanelEventSetDescriptor() {
	java.beans.EventSetDescriptor aDescriptor = null;
	try {
		try {
			/* Try using method descriptors to create the fileNamePanel event set descriptor. */
			java.beans.MethodDescriptor eventMethodDescriptors[] = {
				textKeyReleased_javaawteventKeyEventMethodEventDescriptor()			};
			java.lang.reflect.Method anAddMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class anAddMethodParameterTypes[] = {
					ch.softenvironment.view.FileNamePanelListener.class
				};
				anAddMethod = getBeanClass().getMethod("addFileNamePanelListener", anAddMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				anAddMethod = findMethod(getBeanClass(), "addFileNamePanelListener", 1);
			};
			...
			try {
				...
				aRemoveMethod = getBeanClass().getMethod("removeFileNamePanelListener", aRemoveMethodParameterTypes);
			} catch (Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aRemoveMethod = findMethod(getBeanClass(), "removeFileNamePanelListener", 1);
			};
			...
			aDescriptor = new java.beans.EventSetDescriptor(getBeanClass(), 
						...
						ch.softenvironment.view.FileNamePanelListener.class, 
						eventMethodNames, 
						"addFileNamePanelListener", 
						"removeFileNamePanelListener");
		};
		/* aDescriptor.setUnicast(false); */
		/* aDescriptor.setDisplayName("fileNamePanel"); */
		/* aDescriptor.setShortDescription("fileNamePanel"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
...
public static java.lang.Class getBeanClass() {
	return ch.softenvironment.view.FileNamePanel.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the FileNamePanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(ch.softenvironment.view.FileNamePanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
public java.beans.EventSetDescriptor[] getEventSetDescriptors() {
	try {
		java.beans.EventSetDescriptor aDescriptorList[] = {
			fileNamePanelEventSetDescriptor()
		};
...
/**
 * Gets the textKeyReleased(java.awt.event.KeyEvent) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor textKeyReleased_javaawteventKeyEventMethodEventDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the textKeyReleased(java.awt.event.KeyEvent) method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {
			...
			aMethod = (ch.softenvironment.view.FileNamePanelListener.class).getMethod("textKeyReleased", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod((ch.softenvironment.view.FileNamePanelListener.class), "textKeyReleased", 1);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
		...
		aDescriptor.setDisplayName("textKeyReleased(java.awt.event.KeyEvent)");
		/* aDescriptor.setShortDescription("textKeyReleased(java.awt.event.KeyEvent)"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
