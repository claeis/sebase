...
/**
 * Extended JTextField to show a java.util.Date.
 * Allows visual connection of Attribute-to-Attribute connection from e.g.
 * a Date-Property of a Model to this Components value-Property. Make sure
 * to trigger <b>propertyChange</b>-Event "date" from this Component towards the Model.
