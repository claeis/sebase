...
public class ColorChooserDialog extends BaseDialog {
    ...
    /**
     * connEtoC1:
     * (BtnAbbrechen.action.actionPerformed(java.awt.event.ActionEvent) -->
     * ColorChooser.cancelPressed()V)
     * 
     * @param arg1
	...
	if (ivjBaseDialogContentPane == null) {
		...
		constraintsColChooser.gridx = 1;
		constraintsColChooser.gridy = 1;
