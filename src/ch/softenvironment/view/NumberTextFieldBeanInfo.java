...
/**
 * The bean information class for ch.softenvironment.view.NumberTextField.
 */
public class NumberTextFieldBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return ch.softenvironment.view.NumberTextField.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "ch.softenvironment.view.NumberTextField";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the NumberTextFieldBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(ch.softenvironment.view.NumberTextField.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
...
/**
 * Gets the getDecimalFormat() method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor getDecimalFormatMethodDescriptor() {
	java.beans.MethodDescriptor aDescriptor = null;
	try {
		/* Create and return the getDecimalFormat() method descriptor. */
		java.lang.reflect.Method aMethod = null;
		try {
			/* Attempt to find the method using getMethod with parameter types. */
			java.lang.Class aParameterTypes[] = {};
			aMethod = getBeanClass().getMethod("getDecimalFormat", aParameterTypes);
		} catch (Throwable exception) {
			/* Since getMethod failed, call findMethod. */
			handleException(exception);
			aMethod = findMethod(getBeanClass(), "getDecimalFormat", 0);
		};
		try {
			/* Try creating the method descriptor with parameter descriptors. */
			java.beans.ParameterDescriptor aParameterDescriptors[] = {};
		...
		/* aDescriptor.setDisplayName("getDecimalFormat()"); */
		/* aDescriptor.setShortDescription("getDecimalFormat()"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new Boolean(false)); */
	} catch (Throwable exception) {
