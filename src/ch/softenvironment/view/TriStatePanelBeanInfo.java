...
public static java.lang.Class getBeanClass() {
	return ch.softenvironment.view.TriStatePanel.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "ch.softenvironment.view.TriStatePanel";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the TriStatePanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(ch.softenvironment.view.TriStatePanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
