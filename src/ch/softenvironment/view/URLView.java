...
private void browse() {
	try {
		...
		BaseDialog.showWarning((java.awt.Component)this, ResourceManager.getResource(URLView.class, "CT_BrowserError"), e.toString());
	}
}
/**
...
private javax.swing.JButton getBtnBrowser() {
	if (ivjBtnBrowser == null) {
		try {
			...
			ivjBtnBrowser.setToolTipText("in Browser öffnen...");
...
private void initialize() {
	try {
		...
		constraintsTxtURL.gridx = 1; constraintsTxtURL.gridy = 1;
		...
		constraintsBtnBrowser.gridx = 2; constraintsBtnBrowser.gridy = 1;
...
public void removeURLViewListener(ch.softenvironment.view.URLViewListener newListener) {
	fieldURLViewListenerEventMulticaster = ch.softenvironment.view.URLViewListenerEventMulticaster.remove(fieldURLViewListenerEventMulticaster, newListener);
	return;
}
/**
 * Method generated to support the promotion of the text attribute.
