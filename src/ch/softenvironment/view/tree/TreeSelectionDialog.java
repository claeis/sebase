...
private javax.swing.JPanel getBaseDialogContentPane() {
	if (ivjBaseDialogContentPane == null) {
		try {
			...
			constraintsScpTree.gridx = 1; constraintsScpTree.gridy = 1;
...
/*    MouseListener ml = new MouseAdapter() {
        public void mouseClicked(MouseEvent e) {
            int selectedRow = getTreTree().getRowForLocation(e.getX(), e.getY());
            if (selectedRow != -1) {
	            TreePath selectedPath = getTreTree().getPathForLocation(e.getX(), e.getY());
