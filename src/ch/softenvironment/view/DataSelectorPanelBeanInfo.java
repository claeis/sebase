	...
	try {
		try {
			...
			try {
				...
				aSetMethod = getBeanClass().getMethod("setCurrentObject", aSetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setCurrentObject", 1);
			};
...
public static java.lang.Class getBeanClass() {
	return DataSelectorPanel.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "ch.ehi.basics.view.DataSelectorPanel";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the DataSelectorPanelBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(DataSelectorPanel.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
