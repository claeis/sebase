...
/**
 * The bean information class for ch.softenvironment.view.DateTextField.
 */
public class DateTextFieldBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
/**
 * Gets the date property descriptor.
 * @return java.beans.PropertyDescriptor
 */
public java.beans.PropertyDescriptor datePropertyDescriptor() {
	java.beans.PropertyDescriptor aDescriptor = null;
	try {
		try {
			/* Using methods via getMethod is the faster way to create the date property descriptor. */
			java.lang.reflect.Method aGetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aGetMethodParameterTypes[] = {};
				aGetMethod = getBeanClass().getMethod("getDate", aGetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aGetMethod = findMethod(getBeanClass(), "getDate", 0);
			};
			java.lang.reflect.Method aSetMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				...
				aSetMethod = getBeanClass().getMethod("setDate", aSetMethodParameterTypes);
			} catch (java.lang.Throwable exception) {
				/* Since getMethod failed, call findMethod. */
				handleException(exception);
				aSetMethod = findMethod(getBeanClass(), "setDate", 1);
			};
			aDescriptor = new java.beans.PropertyDescriptor("date"
			, aGetMethod, aSetMethod);
		} catch (java.lang.Throwable exception) {
			/* Since we failed using methods, try creating a default property descriptor. */
			handleException(exception);
		...
		/* aDescriptor.setConstrained(false); */
		/* aDescriptor.setDisplayName("date"); */
		/* aDescriptor.setShortDescription("date"); */
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
		/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
		/* aDescriptor.setValue("ivjDesignTimeProperty", new java.lang.Boolean(true)); */
...
public static java.lang.Class getBeanClass() {
	return ch.softenvironment.view.DateTextField.class;
}
/**
...
public java.beans.BeanDescriptor getBeanDescriptor() {
	...
	try {
		/* Create and return the DateTextFieldBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(ch.softenvironment.view.DateTextField.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
