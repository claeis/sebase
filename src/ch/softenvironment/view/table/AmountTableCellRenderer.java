 ...
 * @version $Revision: 1.3 $ $Date: 2005-02-03 14:23:40 $
 */
...
public AmountTableCellRenderer() {
	...
	amountFormat = ch.softenvironment.util.AmountFormat.getAmountInstance();
}
/**
 * Overwrites.
 */
...
protected void setValue(Object value) {
    try {
		setText((value == null) ? "" : amountFormat.format((Number)value));
