...
public class DeveloperException extends RuntimeException {
	 ...
	 * 
	 * @param type
	 *            Class where error happened
	 * @param method
	 *            producing the error
	 * @param title
	 *            Title for ErrorDialog
	 * @param message
	 *            Message for ErrorDialog
	 * @param cause
	 *            Original Exception happened
	 */
	...
	/**
	 * Return the original title of error, for e.g. to use in ErrorDialog as
	 * Title.
	 */
