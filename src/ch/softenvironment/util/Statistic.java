...
/**
 * Statistical utility to evaluate performance for named Use-Cases within an
 * application (for e.g. DBMS Transaction times).
 * 
...
public final class Statistic {
    ...
    private static TreeMap<String, Statistic> statisticMap = new TreeMap<String, Statistic>();
     ...
     * 
     * @param sampleValue
     *            (other values than >0 are ignored)
     * @see #getTimeMeasure()
     */
    ...
    /**
     * Reset all values for all Statistic-instances, where given UseCases remain
     * in List.
     */
