...
public class ImageUtils {
    /**
     * Save current Screen-Contents to given filename in PNG-Format (suffix will
     * be set if missing in filename).
     * 
     * @param filename
     * @throws AWTException 
     ...
     * @param bufferedImage
     * @see http
     *      ://forum.java.sun.com/thread.jspa?threadID=653302&messageID=3840311
     */
