...
/**
 * Reflection-Utility for JavaBeans. Encapsulates an Object's property according
 * to Java Beans Specification, by means a Property is defined usually as
 * follows, if MyObject has a Property "myProperty": -> MyObject#fieldMyProperty
 * // field/property itself -> MyObject#setMyProperty(Object any) // the
 * setter-Method -> MyObject#getMyProperty() // the getter-Method
 * 
...
public class BeanReflector {
     ...
     * @param property
     *            property of interest of given source (starts with lowercase)
     * 
     *            Example: change = new ObjectProperty(Locale.getDefault,
     *            "language") if (change.getValue().equals("de")) {
    ...
    /**
     * Return the Source's Property-value by calling the sources getter-Method.
     * Primitive types (such as boolean, int, etc) will be returned as their
     * Class Type (such as Boolean, Integer, etc)!
     */
    ...
    /**
     * Set the Property by its <b>setter-Method</b> with given value. The
     * Setter-Method must be public. For e.g.: source.setProperty(Object value)
     * Primitive types (such as boolean, int, etc) will be returned as their
     * Class Type (such as Boolean, Integer, etc)!
     */
