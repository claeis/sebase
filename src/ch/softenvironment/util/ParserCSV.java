...
public class ParserCSV {
    ...
    /**
     * Transform a List into a String with items (according to their
     * #toString()) separated by a Separator.
     * 
     * @param items
     * @return String
     */
    ...
    /**
     * Read a File where fields/cells are separated by a given separator and
     * return a List where each item contains a line of the given Stream.
     * 
     * @param stream
     * @param separator
    ...
    /**
     * Convert the given table as is in CSV-Stream. Useful for dumping contents
     * within a JTable generically into CSV-file. If table selection is made,
     * then only the selected elements will be printed otherwise the whole
     * contents is written.
     * 
     * @param stream
     * @param table
