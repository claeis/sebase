...
public abstract class ListUtils {
	...
	/**
	 * @param property
	 *            Attribute of Objects in list to sort by.
	 */
	...
	public int compare(java.lang.Object o1, java.lang.Object o2) {
		...
		if (o1 == null) {
			...
			if ((v1 instanceof String) && (v2 instanceof String)) {
				...
				// TODO compare might not be correct for any other type
    ...
    /**
     * Sort the given items according to their objects property determined by
     * evaluator.
     * 
     * @param items
     *            list to sorted
    ...
    /**
     * Remove duplicate elements in given list according to equal property value
     * of list-elements.
     * 
     * @param list
     * @param property
	...
	while (it.hasNext()) {
	    T obj = it.next();
	    T value = (T)(new BeanReflector(obj, property)).getValue();
     ...
     * where elements are separated by given separator. <example>
     * list.add(myObject); // which has a method #getMyListRepresentation()
     * ListUtils.convertToString(list, "myListRepresentation", ';') </example>
     * 
     * @param method
     *            non-argument method which must evaluate to String
     * @param list
     * @return
     */
    public static <T> String convertToString(java.util.List<T> list, String method, final char separator) {
