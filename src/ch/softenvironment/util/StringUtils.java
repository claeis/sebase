...
public abstract class StringUtils {
    ...
    /**
     * Cut off value if longer than given length for e.g.
     * getStringLimited("abcdefgh", 5) => "abcd.."
     * 
     * @param value
     * @param length
     * @return
    ...
    /**
     * Replace all occurrences of searchTerm by replacement in buffer, for e.g.
     * StringUtils.replace("X AS C, Attr1 AS Dummy", " AS ", " ") =>
     * "X C, Attr1 Dummy"
     * 
     * @return String
     */
    ...
    /**
     * Append the given suffix to given filename if not already added and return
     * expression.
     * 
     * @param filename
     * @param suffix
    ...
    /**
     * Make the given filename a real creatable filename in OS filesystem. (Some
     * characters are not welcome, such as: ':', '/' etc)
     * 
     * @param filename
